    ...
    GOODWIN.product = {
        ...
        productHeightResize: function(product) {
            $(product).each(function() {
                ...
                $('.color-swatch', $this).css({
                    'bottom': ''
                });
                $('.countdown-box', $this).css({
                    'bottom': ''
                });
            })
        },
            ...
            $document.on('mouseenter', product, function(e) {
                ...
                if (!$this.hasClass('hovered')) {
                    ...
                    if ($this.hasClass('prd-style2') && !$this.hasClass('prd-outstock')) {
                        ...
                        $('.prd-info', $this).stop().animate({
                            'top': -shiftY + 'px'
                        }, speed);
                        $('.color-swatch', $this).stop().animate({
                            'bottom': $this.data('bottom1') + shiftY
                        }, speed);
                        $('.countdown-box', $this).stop().animate({
                            'bottom': $this.data('bottom2') + shiftY
                        }, speed);
                    }
                }
