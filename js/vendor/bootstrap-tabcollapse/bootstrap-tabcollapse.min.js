! function(t) {
    ...
    a.DEFAULTS = {
        ...
        accordionTemplate: function(t, a, e, s) {
            return '<div class="panel panel-default">   <div class="panel-heading ' + (s ? "active" : "") + '">      <h4 class="panel-title">      </h4>   </div>   <div id="' + a + '" class="panel-collapse collapse ' + (s ? "in" : "") + '">       <div class="panel-body js-tabcollapse-panel-body">       </div>   </div></div>'
        }
        ...
        if (this.$tabs.find('li:not(.dropdown) [data-toggle="tab"], li:not(.dropdown) [data-toggle="pill"]').each(function() {
                var e = t(this),
                    s = e.parent();
                e.data("bs.tabcollapse.parentLi", s), a.$accordion.append(a._createAccordionGroup(a.$accordion.attr("id"), e.detach()))
        ...
        this.$accordion = t('<div class="panel-group ' + this.options.accordionClass + '" id="' + e + '"></div>'), this.$tabs.after(this.$accordion), this.$tabs.addClass(this.options.tabsClass), this.getTabContentElement().addClass(this.options.tabsClass)
